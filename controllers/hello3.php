...
class Hello3 extends CI_Controller{
	...
	{ parent::__construct(); // give default value 
	$this->name="Faisal"; $this->color="blue"; } 
	function you($firstname='', $lastname='')
	// Give variable that can GET value 
	{ 
	$data['name']=($firstname)?$firstname.' '.$lastname:$this->name;
	$data['color']=$this->color; // define variable sent to views 
